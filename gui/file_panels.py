...
class FilePanel(ttk.Frame):
    ...
    def new_rocket(self):
        ...
        self.controller.rocket.static_params = read_csv(self.rocket_file)
    ...
    def new_motor(self):
        ...
        if self.motor_file[-3:] == 'eng':
            ...
            self.log("Detected motor dimension file")
            self.log("Loaded new motor dimensions and thrust curve")
        else:
            self.controller.motor.set_spec(self.motor_file)
            self.log("Detected motor dimension file")
    ...
    def new_thrust(self):
        ...
        if self.motor_file == '':
            ...
            self.controller.motor.update_thrust(self.thrust_file)
